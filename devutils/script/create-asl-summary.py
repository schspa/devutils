...
def GenerateXML(filename, regtypes) :
    ...
    for regtype in regtypes:
        ...
        for reg in regtype['regs']:
            ...
            basepath_node = root.createElement('basepath')
            basepath_text=root.createTextNode(reg['basepath'])
            basepath_node.appendChild(basepath_text)
            reg_node.appendChild(basepath_node)
